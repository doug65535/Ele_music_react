...
import ELESongOperationBar from '@/components/song-operation-bar';
import {
  RankingHeaderWrapper
} from './style';

export default memo(function ELERankingHeader() {
  // redux
  ...
  return (
    <RankingHeaderWrapper>
      ...
      <div className="info">
        ...
        <ELESongOperationBar favorTitle={`(${topInfo.subscribedCount})`}
