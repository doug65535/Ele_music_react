...
import ELEThemeCover from '@/components/theme-cover';

export default memo(function ELEHotRecommend() {
  // redux
      ...
      <div className="recommend-list">
        {
          state.recommends.slice(0, 8).map((item, index) => {
            return (
              <ELEThemeCover info={item} key={item.id}/>
            )
          })
        }
      </div>
